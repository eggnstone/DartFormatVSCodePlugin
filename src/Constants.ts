export class Constants
{
    ...
    static readonly DEBUG_FAKE_FLUTTER_SDK_DOWNLOAD = Constants.DEBUG && false; // pretend Flutter is downloading the Dart SDK during dart_format startup
    static readonly DEBUG_FAKE_FORMAT_DELAY = Constants.DEBUG && false;     // 1 s cancelable sleep before each format, to test the Cancel button
    ...
    static readonly DEBUG_FAKE_SHOW_WELCOME = Constants.DEBUG && false;     // force the welcome notification every activation, ignoring/not updating `welcomeShown`
